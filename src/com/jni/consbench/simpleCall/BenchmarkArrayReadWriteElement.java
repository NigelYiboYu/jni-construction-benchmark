...
public class BenchmarkArrayReadWriteElement {
	...
	private static String testName = "testArrayReadWriteElement";
	...
	private static void doTest(boolean doPrint) {
		...
		for (long j = 0; j < ITERATIONS; j++) {
			simpleCalls.testArrayReadWriteElement(array, j, result);
		}
